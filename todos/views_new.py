...
def broadcast_todo_update(user_id, action, todo_data):
    """Send WebSocket update to user's channel"""
...
def create_todo(request):
    ...
    try:
        ...
        broadcast_todo_update(request.user.id, 'create', todo_data)
...
def finish_todo(request, todo_id):
    ...
    try:
        ...
        # Broadcast to WebSocket
        broadcast_todo_update(request.user.id, 'finish', todo_data)
...
def unfinish_todo(request, todo_id):
    ...
    try:
        ...
        # Broadcast to WebSocket
        broadcast_todo_update(request.user.id, 'unfinish', todo_data)
...
def delete_todo(request, todo_id):
    ...
    try:
        ...
        # Broadcast to WebSocket
        broadcast_todo_update(request.user.id, 'delete', todo_data)
